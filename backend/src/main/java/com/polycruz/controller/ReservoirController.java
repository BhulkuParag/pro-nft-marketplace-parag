...
public class ReservoirController {
    ...
    public ResponseEntity<TechResponse<TrendingMintsResponse>> getTrendingMints(
        ...
        return new ResponseEntity<>(
                transformer.transform(vendorService.getTrendingMints(chain, period, limit, sortDirection, offset)),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<TechResponse<TokenResponse>> getTokens(
        ...
        return new ResponseEntity<>(transformer.transform(vendorService.fetchTokens(chain, collection, sortBy, limit)),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<TechResponse<NftSalesResponse>> getNftSales(
        ...
        return new ResponseEntity<>(transformer.transform(vendorService.fetchNftSales(chain, includeTokenMetadata)),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<TechResponse<ActivityResponse>> getActivity(
        ...
        return new ResponseEntity<>(
                transformer.transform(vendorService.fetchActivity(chain, sortBy, includeMetadata, types)),
                HttpStatus.OK);
    }
