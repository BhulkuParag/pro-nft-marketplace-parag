...
public class ReservoirController {
        ...
        public ResponseEntity<TechResponse<TrendingApiResponse>> getTrendingCollections(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.getTrendingCollections(chain, period, sortBy)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TrendingMintsResponse>> getTrendingMints(
                        ...
                        @RequestParam(defaultValue = "0") int offset) {
                return new ResponseEntity<>(
                                transformer.transform(vendorService.getTrendingMints(chain, period, limit,
                                                sortDirection, offset)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenResponse>> getTokens(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.fetchTokens(chain, collection, sortBy, limit)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenResponse>> getTokenData(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchTokenData(chain, tokens, sortBy)),
                                HttpStatus.OK);
        ...
        public ResponseEntity<TechResponse<NftSalesResponse>> getNftSales(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.fetchNftSales(chain, includeTokenMetadata)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<ActivityResponse>> getActivity(
                        ...
                        @Parameter(description = "Type of event. Example: ask_cancel", schema = @Schema(allowableValues = {
                                        "ask_cancel", "sale", "mint", "transfer", "ask", "bid",
                                        "bid_cancel" }, defaultValue = "")) @RequestParam(required = false) String types) {
                return new ResponseEntity<>(
                                transformer.transform(
                                                vendorService.fetchActivity(chain, sortBy, includeMetadata, types)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenDetail>> getTokenDetails(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchTokenDetails(chain, currency)),
                                HttpStatus.OK);
        }
    ...
    @GetMapping("/collection/v1")
     ...
     public ResponseEntity<TechResponse<NftCollectionResponse>> getCollectionData(@RequestParam ReservoirChain chain
        ...
        public ResponseEntity<TechResponse<NftCollectionResponse>> getCollectionData(@RequestParam ReservoirChain chain
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.getAiValuationOnLoad(chain)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<ActivityResponse>> fetchActivities(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.fetchActivities(chain, collection, type)),
                                HttpStatus.OK);
        }
    ...
    public ResponseEntity<TechResponse<NftPriceEstimateResponse>> getNftPriceEstimate(
        ...
        public ResponseEntity<TechResponse<MarketMetricResponse>> getMetrics(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.getMarketMetrics(currency, blockchain, timeRange)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<MarketMetricResponse>> getMetrics(
                ...
                return new ResponseEntity<>(transformer.transform(
                                vendorService.getMarketMetrics(currency, blockchain, timeRange, includeWashtrade)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<MergedMetricResponse>> getMergedMetrics(
                ...
                MarketMetricResponse marketMetrics2 = vendorService.getMarketMetrics(currency, blockchain, timeRange,
                                includeWashtrade);
                MarketMetricResponse marketMetrics3 = vendorService.getMarketMetrics(currency, blockchain, timeRange2,
                                includeWashtrade);
                return new ResponseEntity<>(transformer
                                .transform(vendorService.mergeMetrics(marketMetrics, marketMetrics2, marketMetrics3)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<ActivityResponse>> getUserActivity(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.getUserActivity(wallet, sortBy, includeMetadata)),
                                HttpStatus.OK);
        }

        @GetMapping("/attributes")
        public ResponseEntity<TechResponse<AttributeExploreResponse>> getAttributes(
                        @RequestParam(defaultValue = "936") Integer tokenId) {
                return new ResponseEntity<>(transformer.transform(vendorService.getAttributesByTokenId(tokenId)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<ActivityResponse>> getTokenActivity(
                ...
                return new ResponseEntity<>(transformer.transform(
                                vendorService.getTokenActivity(contract, tokenId, sortBy, includeTokenMetadata)),
                                HttpStatus.OK);
        }
}
