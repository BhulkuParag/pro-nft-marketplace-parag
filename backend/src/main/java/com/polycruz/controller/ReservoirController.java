...
public class ReservoirController {
        ...
        public ResponseEntity<TechResponse<TrendingMintsResponse>> getTrendingMints(
                ...
                return new ResponseEntity<>(
                                transformer.transform(
                                                vendorService.getTrendingMints(period, limit, sortDirection, offset)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenResponse>> getTokens(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchTokens(collection, sortBy, limit)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenResponse>> getTokenData(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchTokenData(tokens, sortBy)),
                                HttpStatus.OK);
        ...
        public ResponseEntity<TechResponse<NftSalesResponse>> getNftSales(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchNftSales(includeTokenMetadata)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<ActivityResponse>> getActivity(
                ...
                return new ResponseEntity<>(
                                transformer.transform(vendorService.fetchActivity(sortBy, includeMetadata, types)),
                                HttpStatus.OK);
        }
        ...
        public ResponseEntity<TechResponse<TokenDetail>> getTokenDetails(
                ...
                return new ResponseEntity<>(transformer.transform(vendorService.fetchTokenDetails(currency)),
                                HttpStatus.OK);
        }
