...
const CollectionHero: React.FC<CollectionHeroProps> = ({
    ...
    const shownText = expanded || !isLong ? description : description.slice(0, MAX_CHARS) + '...';
    ...
    return (
        ...
        >
            ...
            <Box sx={{ flex: 1 }}>
                ...
                <Typography variant="subtitle1" sx={{ color: '#fff', opacity: 0.8, mb: 1, fontSize: '14px' }}>
                    by {subtitle}
                </Typography>
                <Typography
                    variant="body1"
                ...
                {isLong && (
                    <Button
                        variant="text"
                        sx={{ color: '#fff', fontWeight: 500, textTransform: 'none', mb: 0.5, p: 0, minWidth: 0, textDecoration: 'underline' }}
