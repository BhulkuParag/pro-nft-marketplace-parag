...
//                 <div key={index} className="bg-white dark:bg-dark-secondary-dark p-3 md:p-6 rounded-xl w-full flex-grow justify-center flex flex-col gap-5 items-center">
...
//                                 <SelectValue />
//                             </SelectTrigger>
//                             <SelectContent className="bg-white dark:bg-dark-secondary-dark">
//                                 <SelectGroup>
