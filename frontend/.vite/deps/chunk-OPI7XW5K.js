...
function useWalletImage(id) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const { getInstalledWalletProviders: getInstalledWalletProviders2 } = await import("./mipdStore-E2MMMO63.js");
...
var BackButton = (props) => {
  return (0, import_jsx_runtime5.jsx)(IconButton, { onClick: props.onClick, style: { transform: "translateX(-25%)", ...props.style }, type: "button", children: (0, import_jsx_runtime5.jsx)(ChevronLeftIcon, { height: iconSize.md, width: iconSize.md }) });
};
...
function ModalHeader(props) {
  ...
  return (0, import_jsx_runtime6.jsxs)("div", { style: {
    alignItems: "center",
    display: "flex",
...
function Container(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(Box, { bg: props.bg, borderColor: props.borderColor, color: props.color, "data-animate": props.animate, "data-scrolly": props.scrollY, style: {
    ...styles,
    ...props.style
...
var PREFERRED_FIAT_PROVIDER_STORAGE_KEY = "preferredFiatProvider";
...
var Skeleton = (props) => {
  return (0, import_jsx_runtime8.jsx)(SkeletonDiv, { className: props.className || "", color: props.color, style: {
    height: props.height,
...
var PhoneIcon = (props) => {
  const clipPathId = (0, import_react8.useId)();
  return (0, import_jsx_runtime13.jsxs)("svg", { fill: "none", height: props.size, role: "presentation", viewBox: "0 0 16 16", width: props.size, xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime13.jsx)("g", { clipPath: `url(#${clipPathId})`, children: (0, import_jsx_runtime13.jsx)("path", { d: "M14.6669 11.2802V13.2802C14.6677 13.4659 14.6297 13.6497 14.5553 13.8198C14.4809 13.9899 14.3718 14.1426 14.235 14.2681C14.0982 14.3937 13.9367 14.4892 13.7608 14.5487C13.5849 14.6082 13.3985 14.6303 13.2136 14.6136C11.1622 14.3907 9.19161 13.6897 7.46028 12.5669C5.8495 11.5433 4.48384 10.1777 3.46028 8.56689C2.3336 6.8277 1.63244 4.84756 1.41361 2.78689C1.39695 2.60254 1.41886 2.41673 1.47795 2.24131C1.53703 2.06589 1.63199 1.90469 1.75679 1.76797C1.88159 1.63126 2.03348 1.52203 2.20281 1.44724C2.37213 1.37245 2.55517 1.33374 2.74028 1.33356H4.74028C5.06382 1.33038 5.37748 1.44495 5.62279 1.65592C5.8681 1.86689 6.02833 2.15986 6.07361 2.48023C6.15803 3.12027 6.31458 3.74871 6.54028 4.35356C6.62998 4.59218 6.64939 4.8515 6.59622 5.10081C6.54305 5.35012 6.41952 5.57897 6.24028 5.76023L5.39361 6.60689C6.34265 8.27592 7.72458 9.65786 9.39361 10.6069L10.2403 9.76023C10.4215 9.58099 10.6504 9.45746 10.8997 9.40429C11.149 9.35112 11.4083 9.37053 11.6469 9.46023C12.2518 9.68593 12.8802 9.84248 13.5203 9.92689C13.8441 9.97258 14.1399 10.1357 14.3513 10.3852C14.5627 10.6348 14.6751 10.9533 14.6669 11.2802Z", stroke: props.color ?? "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.33333" }) }), (0, import_jsx_runtime13.jsx)("defs", { children: (0, import_jsx_runtime13.jsx)("clipPath", { id: clipPathId, children: (0, import_jsx_runtime13.jsx)("rect", { fill: "white", height: "16", width: "16" }) }) })] });
};
...
var Img = (props) => {
  ...
  if (propSrc === void 0) {
    return (0, import_jsx_runtime14.jsx)(Skeleton, { height: heightPx, width: widthPx });
  }
  const getSrc = () => {
    try {
  ...
  return (0, import_jsx_runtime14.jsxs)("div", { style: {
    ...
    justifyItems: "center",
    position: "relative"
  }, children: [!isLoaded && (0, import_jsx_runtime14.jsx)(Skeleton, { height: heightPx, width: widthPx }), (0, import_jsx_runtime14.jsx)("img", { alt: props.alt || "", className: props.className, decoding: "async", draggable: false, height: props.height, loading: props.loading, onError: (e) => {
...
function WalletImage(props) {
  const theme = useCustomTheme();
  const [image, setImage] = (0, import_react10.useState)(void 0);
...
//# sourceMappingURL=chunk-OPI7XW5K.js.map
